...
1. NAP CONSISTENTE: usa siempre el mismo nombre, mismo teléfono formateado igual
   (+56 9 6588 9226 con espacios o +56965889226 sin espacios según pida el sitio),
...
8. Si el portal envia leads por email/SMS, configura la notificacion al telefono
   +56 9 6588 9226 y email contacto@destaperapido.cl.
...
3. Descripcion del aviso: usa la version MEDIA C de la hoja NAP. Al final agrega:
   "Llama o escribe ahora: +56 9 6588 9226 (WhatsApp 24/7).
   Web: www.destaperapido.cl"

4. Telefono de contacto: +56 9 6588 9226.
...
7. Telefono / WhatsApp: +56 9 6588 9226 (marca como WhatsApp donde se pueda).
